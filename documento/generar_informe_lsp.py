...
ARCHIVO_CONTENIDO = CARPETA_DOCUMENTO / "contenido-documento-lsp.md"
ARCHIVO_PORTADA = CARPETA_DOCUMENTO / "datos-portada-lsp.md"
ARCHIVO_MATRIZ = RAIZ / "trazabilidad" / "lsp-rf-rnf-criterios.md"
ARCHIVO_HISTORIAL = RAIZ / "evidencia" / "evidencia-lsp.md"
ARCHIVO_ESTRUCTURA = RAIZ / "evidencia" / "estructura-repositorio.txt"
ARCHIVO_REFERENCIA = RAIZ / "evidencia" / "referencia-git.md"

SALIDA = CARPETA_DOCUMENTO / "Informe_LSP_ASII-08_Esau_Mendoza.docx"
...
def agregar_contenido_seccion(documento, seccion):
    ...
    if numero == "3":
        ...
        agregar_figura(
            documento,
            CARPETA_DIAGRAMAS / "lsp-diseno-antes.png",
            "Figura 1. Diseño antes de aplicar LSP.",
        )
        ...
        agregar_figura(
            documento,
            CARPETA_DIAGRAMAS / "lsp-diseno-despues.png",
            "Figura 2. Diseño después de aplicar LSP.",
        )
